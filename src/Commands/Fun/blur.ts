...
export default class BlurCommand extends Command {
    ...
    run: CommandRunner = async (client, message, args, prefix) => {
        ...
        return message.channel.send(new MessageAttachment(await canvacord.Canvas.blur(user.displayAvatarURL({ dynamic: false, format: "png" })), "delete.png"));
    };
};