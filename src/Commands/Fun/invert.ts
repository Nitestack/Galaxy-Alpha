...
export default class InvertCommand extends Command {
    ...
    run: CommandRunner = async (client, message, args, prefix) => {
        ...
        return message.channel.send(new MessageAttachment(await canvacord.Canvas.invert(user.displayAvatarURL({ dynamic: false, format: "png" })), "delete.png"));
    };
};