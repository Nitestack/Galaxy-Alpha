...
export default class DeleteFileCommand extends Command {
    constructor(){
        super({
            name: "deletefile",
            description: "deletes a file",
            category: "fun",
            usage: "deletefile [@User/User ID]"
        });
    };
    run: CommandRunner = async (client, message, args, prefix) => {
        ...
        return message.channel.send(new MessageAttachment(await canvacord.Canvas.delete(user.displayAvatarURL({ dynamic: false, format: "png" })), "delete.png"));
    };
};